...
set(Qt5Mqtt_VERSION_STRING 5.12.1)
...
macro(_populate_Mqtt_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::Mqtt PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5Mqtt.so"
...
if (NOT TARGET Qt5::Mqtt)
    ...
    set(Qt5Mqtt_PRIVATE_INCLUDE_DIRS
        "${_qt5Mqtt_install_prefix}/include/QtMqtt/5.12.1"
        "${_qt5Mqtt_install_prefix}/include/QtMqtt/5.12.1/QtMqtt"
    )
    ...
    foreach(_module_dep ${_Qt5Mqtt_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.1 ${_Qt5Mqtt_FIND_VERSION_EXACT}
    ...
    _populate_Mqtt_target_properties(RELEASE "libQt5Mqtt.so" "" )
